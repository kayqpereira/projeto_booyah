            ...
            <ul class="navbar-nav ml-md-auto align-items-center">
                ...
                <li class="nav-item dropdown mx-1">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="users" class="svg-inline--fa fa-users fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="0 0 640 512">
                ...
                <li class="nav-item dropdown mx-1">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="boxes" class="svg-inline--fa fa-boxes fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" width="18" height="16" viewBox="0 0 576 512">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="index.php?classe=ProdutoController&metodo=abrirCadastro"><i class="fas fa-plus"></i> Cadastrar</a>
                        <a class="dropdown-item" href="index.php?classe=ProdutoController&metodo=abrirConsulta"><i class="fas fa-search"></i> Consultar</a>
                    </div>
                </li>

                <li class="nav-item mx-1">
                    <a class="nav-link" href="index.php?classe=CategoriaController&metodo=abrirCadastro">
                ...
                <li class="nav-item mx-1">
                    <a class="nav-link" href="index.php?classe=MarcaController&metodo=abrirCadastro">
