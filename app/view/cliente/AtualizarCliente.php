...
<body class="cli">
    ...
    <main class="container-fluid">
        ...
        <form action="index.php?classe=ClienteController&metodo=atualizarCliente&session=start" method="post" onsubmit="return validarForm()" novalidate id="frmEditarCli" class="frmCli container">
