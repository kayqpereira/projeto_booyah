...
<body class="adm">
    <main class="container-fluid">
        ...
        <form action="index.php?classe=EnderecoController&metodo=atualizarEndereco" method="post" onsubmit="return validarForm()" novalidate id="frmEditarEnd" class="frmEditarEnd container">
